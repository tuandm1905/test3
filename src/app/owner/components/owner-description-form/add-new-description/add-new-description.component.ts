...
@Component({
  selector: 'app-add-new-description',
  templateUrl: './add-new-description.component.html',
  styleUrl: './add-new-description.component.scss'
})
export class AddNewDescriptionComponent {
